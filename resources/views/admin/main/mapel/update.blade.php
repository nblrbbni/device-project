        ...
        <div class="card">
            <div class="card-body">
                <form action="/mapel/{{ $mapel->id }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="mb-3">
                        <label class="form-label">Update Data Mata Pelajaran</label>
                        <input type="text" name="mapel" value="{{ $mapel->mapel }}" class="form-control">
                    </div>
                    @error('mapel')
                    ...
                    <a href="/mapel" class="btn btn-primary">Back</a>
                </form>
            </div>
        </div>
        {{-- <div class="row">
