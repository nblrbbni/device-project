...
@section('content')
    <div class="section-body">
        <h1 class="mb-3">Data Device Printer</h1>
        <div class="card">
            <div class="card-header">
                <h4>Peminjaman Printer</h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover text-center" id="myTable">
                        ...
                        <tbody>
                            @forelse ($pinjamprinter as $key => $value)
                               <tr>
                                    ...
                                    <td>
                                        <form action="/peminjaman-printer/{{ $value->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="/peminjaman-printer/{{ $value->id }}/delete" class="btn btn-danger"
