...
@section('content')
    <div class="section-body">
        <h1 class="mb-3">Data Device Flashdisk</h1>
        <div class="card">
            <div class="card-header">
                <h4>Peminjaman Flashdisk</h4>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @forelse ($pinjamflashdisk as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <form action="/peminjaman-flashdisk/{{ $value->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="/peminjaman-flashdisk/{{ $value->id }}/delete" class="btn btn-danger"
