...
@section('content')
    <div class="section-body">
        <h1 class="mb-3">Data Device Tablet</h1>
        <div class="card">
            <div class="card-header">
                <h4>Peminjaman Tablet</h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover text-center" id="myTable">
                        ...
                        <tbody>
                            @forelse ($pinjamtablet as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <form action="/peminjaman-tablet/{{ $value->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="/peminjaman-tablet/{{ $value->id }}/delete" class="btn btn-danger"
