...
@section('content')
    <div class="page-wrapper">
      ...
      <div class="container-xl">
        ...
        <div class="page-body">
            <div class="container-xl">
                <h1>Halaman Data Hardisk</h1>
                <a href="/datahardisk/create" class="btn btn-primary mb-3">Tambah</a>
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($datahardisk as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->status }}</td>
                                        <td>
                                            <form action="/datahardisk/{{ $value->id }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a href="/datahardisk/{{ $value->id }}/edit" class="btn"
                                                    style="background-color:#14274c; color:white">Edit</a>
                                                <a href="/datahardisk/{{ $value->id }}/delete" class="btn btn-danger" onclick="confirmation(event)"
                                                    data-id="{{ $value->id }}"
