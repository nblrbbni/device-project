...
@section('content')
    <div class="page-wrapper">
      ...
      <div class="container-xl">
        ...
        <div class="page-body">
            <div class="container-xl">
                <h1>Halaman Data Camera</h1>
                <a href="/datacamera/create" class="btn btn-primary mb-3">Tambah</a>
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($datacamera as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->status }}</td>
                                        <td>
                                            <form action="/datacamera/{{ $value->id }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a href="/datacamera/{{ $value->id }}/edit" class="btn"
                                                    style="background-color:#14274c; color:white">Edit</a>
                                                <a href="/datacamera/{{ $value->id }}/delete" class="btn btn-danger" onclick="confirmation(event)"
                                                    data-id="{{ $value->id }}"
