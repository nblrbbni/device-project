            ...
            <form action="/profile/update" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-flat">
                        <input id="password" type="password" class="form-control" name="password" placeholder="Masukkan password baru Anda">
                ...
                <button type="submit" class="btn" style="background-color:#18244c; color:white" onclick="submitForm(event)">Submit</button>
            </form>
          </div>
        </div>
      </div>
